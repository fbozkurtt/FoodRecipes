...
namespace FoodRecipes.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        static CommonHelper()
        {
            EmailRegex = new Regex(EMAIL_EXPRESSION, RegexOptions.IgnoreCase);
        }
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new FoodRecipesException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new FoodRecipesException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new FoodRecipesException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        /// </summary>
        public static IFoodRecipesFileProvider DefaultFileProvider { get; set; }
