namespace FoodRecipes.Core.Domain.Users
{
    ...
    /// </summary>
    public static partial class FoodRecipesUserDefaults
    {
        ...
        /// </summary>
        public static string CustomUserAttributes => "CustomCustomerAttributes";
        ...
        /// </summary>
        public static string ImpersonatedUserIdAttribute => "ImpersonatedCustomerId";
