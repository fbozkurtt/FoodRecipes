...
using FoodRecipes.Core.Infrastructure.Mapper;
using Microsoft.Extensions.Configuration;
using Nop.Core.Infrastructure;

namespace FoodRecipes.Core.Infrastructure
{
    /// <summary>
    /// Represents Nop engine
    /// </summary>
    public class FoodRecipesEngine : IEngine
    {
        #region Utilities
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = new WebAppTypeFinder();
            var startupConfigurations = typeFinder.FindClassesOfType<IFoodRecipesStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IFoodRecipesStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new FoodRecipesException("Unknown dependency");
                        return service;
                    });
            ...
            throw new FoodRecipesException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
