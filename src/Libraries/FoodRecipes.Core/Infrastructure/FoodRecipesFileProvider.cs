...
namespace FoodRecipes.Core.Infrastructure
{
    ...
    /// </summary>
    public class FoodRecipesFileProvider : PhysicalFileProvider, IFoodRecipesFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a NopFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public FoodRecipesFileProvider(IWebHostEnvironment webHostEnvironment)
