...
namespace FoodRecipes.Data.DataProviders
{
    ...
    /// </summary>
    public partial class MsSqlFoodRecipesDataProvider : BaseDataProvider, IFoodRecipesDataProvider
    {
        #region Fields
        ...
        public virtual string BuildConnectionString(IFoodRecipesConnectionStringInfo foodRecipesConnectionString)
        {
            ...
            {
                DataSource = foodRecipesConnectionString.ServerName,
                InitialCatalog = foodRecipesConnectionString.DatabaseName,
                PersistSecurityInfo = false,
                IntegratedSecurity = foodRecipesConnectionString.IntegratedSecurity
            };

            if (!foodRecipesConnectionString.IntegratedSecurity)
            {
                builder.UserID = foodRecipesConnectionString.Username;
                builder.Password = foodRecipesConnectionString.Password;
            }
