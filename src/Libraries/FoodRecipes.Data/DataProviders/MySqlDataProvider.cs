...
{
    public class MySqlFoodRecipesDataProvider : BaseDataProvider, IFoodRecipesDataProvider
    {
        #region Fields
        ...
        public virtual string BuildConnectionString(IFoodRecipesConnectionStringInfo foodRecipesConnectionString)
        {
            ...
            {
                Server = foodRecipesConnectionString.ServerName,
                ...
                UserID = foodRecipesConnectionString.Username,
