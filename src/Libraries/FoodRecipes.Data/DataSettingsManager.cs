...
namespace FoodRecipes.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// </returns>
        public static async Task<DataConfig> LoadSettingsAsync(IFoodRecipesFileProvider fileProvider = null)
        {
            ...
            var filePath_json = fileProvider.MapPath(FoodRecipesDataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(FoodRecipesDataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(IFoodRecipesFileProvider fileProvider = null)
        {
            if (Singleton<DataConfig>.Instance is not null)
                return Singleton<DataConfig>.Instance;
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, IFoodRecipesFileProvider fileProvider)
        {
