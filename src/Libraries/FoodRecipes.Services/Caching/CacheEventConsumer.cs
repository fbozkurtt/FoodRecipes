...
namespace FoodRecipes.Services.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(FoodRecipesEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(FoodRecipesEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(FoodRecipesEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
