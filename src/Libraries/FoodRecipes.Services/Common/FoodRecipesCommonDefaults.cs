...
namespace FoodRecipes.Services.Common
{
    ...
    /// </summary>
    public static partial class FoodRecipesCommonDefaults
    {
        /// <summary>
        ...
        /// {2} : language code
        /// </remarks>
        public static string FoodRecipesCopyrightWarningPath => "site-warnings?url={0}&local={1}&language={2}";
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new CacheKey("FoodRecipes.genericattribute.{0}-{1}");
