...
namespace FoodRecipes.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(FoodRecipesSettingsDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
        ...
        /// </returns>
        public virtual async Task<T> GetSettingByKeyAsync<T>(string key,
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(FoodRecipesEntityCacheDefaults<Setting>.Prefix);
        }
