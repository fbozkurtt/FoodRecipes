...
namespace FoodRecipes.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesDirectoryDefaults.CountriesAllCacheKey, languageId,
                showHidden);
        ...
        public virtual async Task<Country> GetCountryByTwoLetterIsoCodeAsync(string twoLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesDirectoryDefaults.CountriesByTwoLetterCodeCacheKey, twoLetterIsoCode);
        ...
        public virtual async Task<Country> GetCountryByThreeLetterIsoCodeAsync(string threeLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesDirectoryDefaults.CountriesByThreeLetterCodeCacheKey, threeLetterIsoCode);
