...
namespace FoodRecipes.Services.Helpers
{
    /// <summary>
    ...
    public class BrowscapXmlHelper
    {
        ...
        public BrowscapXmlHelper(string userAgentStringsPath, string crawlerOnlyUserAgentStringsPath, IFoodRecipesFileProvider fileProvider)
        {
