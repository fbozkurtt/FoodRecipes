...
namespace FoodRecipes.Services.ScheduleTasks
{
    ...
    public partial class TaskScheduler : ITaskScheduler
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            var scheduleTaskUrl = $"{host.TrimEnd('/')}/{FoodRecipesTaskDefaults.ScheduleTaskPath}";
        ...
        protected class TaskThread : IDisposable
        {
            ...
            private async Task RunAsync()
            {
                ...
                try
                {
                    ...
                    client = HttpClientFactory.CreateClient(FoodRecipesHttpDefaults.DefaultHttpClient);
                ...
                catch (Exception ex)
                {
                    ...
                    message = string.Format(await localizationService.GetResourceAsync("ScheduleTasks.Error"), _scheduleTask.Name,
                        message, _scheduleTask.Type, _scheduleTaskUrl);
