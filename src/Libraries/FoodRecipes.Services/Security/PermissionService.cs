...
namespace FoodRecipes.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesSecurityDefaults.PermissionRecordsAllCacheKey, userRoleId);
        ...
        public virtual async Task<bool> AuthorizeAsync(string permissionRecordSystemName, int userRoleId)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesSecurityDefaults.PermissionAllowedCacheKey, permissionRecordSystemName, userRoleId);
