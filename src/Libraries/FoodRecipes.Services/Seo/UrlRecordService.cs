...
namespace FoodRecipes.Services.Seo
{
    /// <summary>
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        public virtual async Task<UrlRecord> GetBySlugAsync(string slug)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesSeoDefaults.UrlRecordBySlugCacheKey, slug);
            ...
            string slug = "", int? languageId = null, bool? isActive = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            return new Core.PagedList<UrlRecord>(result, pageIndex, pageSize);
        }
        ...
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(FoodRecipesSeoDefaults.UrlRecordCacheKey, entityId, entityName, languageId);
