...
using FoodRecipes.Web.Framework.Mvc.Filters;
...
namespace FoodRecipes.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        /// </remarks>
        public JsonResult Json<T>(BasePagedListModel<T> model) where T : BaseFoodRecipesModel
        {
            return Json(new
            {
                draw = model.Draw,
