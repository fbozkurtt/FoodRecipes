...
namespace FoodRecipes.Web.Framework.Infrastructure
{
    ...
    /// </summary>
    public class FoodRecipesCommonStartup : IFoodRecipesStartup
    {
        /// <summary>
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddFoodRecipesHttpClients();
            ...
            services.AddRouting(options =>
            {
                ...
                options.ConstraintMap[FoodRecipesPathRouteDefaults.LanguageParameterTransformer] = typeof(LanguageParameterTransformer);
            });
        }
