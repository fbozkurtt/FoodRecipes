...
namespace FoodRecipes.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class FoodRecipesMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new FoodRecipesException("There is already an attribute with the name '{0}' on this model", additionalValue.Name);
