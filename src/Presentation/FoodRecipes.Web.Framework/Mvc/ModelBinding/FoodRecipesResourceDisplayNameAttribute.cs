...
namespace FoodRecipes.Web.Framework.Mvc.ModelBinding
{
    /// <summary>
    /// Represents model attribute that specifies the display name by passed key of the locale resource
    /// </summary>
    public sealed class FoodRecipesResourceDisplayNameAttribute : DisplayNameAttribute, IModelAttribute
    {
        #region Fields
        ...
        public FoodRecipesResourceDisplayNameAttribute(string resourceKey) : base(resourceKey)
        {
        ...
        /// </summary>
        public string Name => nameof(FoodRecipesResourceDisplayNameAttribute);
