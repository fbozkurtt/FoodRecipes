...
using FoodRecipes.Web.Framework.Events;
    ...
    public class SlugRouteTransformer : DynamicRouteValueTransformer
    {
        ...
        public override async ValueTask<RouteValueDictionary> TransformAsync(HttpContext httpContext, RouteValueDictionary values)
        {
            ...
            if (!urlRecord.IsActive)
            {
                ...
                values[FoodRecipesPathRouteDefaults.ControllerFieldKey] = "Common";
                values[FoodRecipesPathRouteDefaults.ActionFieldKey] = "InternalRedirect";
                values[FoodRecipesPathRouteDefaults.UrlFieldKey] = $"{pathBase}/{activeSlug}{httpContext.Request.QueryString}";
                values[FoodRecipesPathRouteDefaults.PermanentRedirectFieldKey] = true;
            ...
            if (_localizationSettings.SeoFriendlyUrlsForLanguagesEnabled)
            {
                ...
                if (urllanguage != null && !string.IsNullOrEmpty(urllanguage.ToString()))
                {
                    ...
                    if (!string.IsNullOrEmpty(slugForCurrentLanguage) && !slugForCurrentLanguage.Equals(slug, StringComparison.InvariantCultureIgnoreCase))
                    {
                        ...
                        values[FoodRecipesPathRouteDefaults.ControllerFieldKey] = "Common";
                        values[FoodRecipesPathRouteDefaults.ActionFieldKey] = "InternalRedirect";
                        values[FoodRecipesPathRouteDefaults.UrlFieldKey] = $"{pathBase}/{language.UniqueSeoCode}/{slugForCurrentLanguage}{httpContext.Request.QueryString}";
                        values[FoodRecipesPathRouteDefaults.PermanentRedirectFieldKey] = false;
                        httpContext.Items["nop.RedirectFromGenericPathRoute"] = true;
            ...
            {
                case "recipe":
                    values[FoodRecipesPathRouteDefaults.ControllerFieldKey] = "Product";
                    values[FoodRecipesPathRouteDefaults.ActionFieldKey] = "ProductDetails";
                    values[FoodRecipesPathRouteDefaults.RecipeIdFieldKey] = urlRecord.EntityId;
                    values[FoodRecipesPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;

                case "category":
                    values[FoodRecipesPathRouteDefaults.ControllerFieldKey] = "Catalog";
                    values[FoodRecipesPathRouteDefaults.ActionFieldKey] = "Category";
                    values[FoodRecipesPathRouteDefaults.CategoryIdFieldKey] = urlRecord.EntityId;
                    values[FoodRecipesPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
