...
namespace FoodRecipes.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("foodrecipes-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class FoodRecipesActionConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
