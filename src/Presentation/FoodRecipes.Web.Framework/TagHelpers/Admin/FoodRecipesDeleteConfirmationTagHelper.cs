...
namespace FoodRecipes.Web.Framework.TagHelpers.Admin
{
    ...
    public class FoodRecipesDeleteConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
