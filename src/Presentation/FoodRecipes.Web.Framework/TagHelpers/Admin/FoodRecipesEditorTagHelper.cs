...
namespace FoodRecipes.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("foodrecipes-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class FoodRecipesEditorTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesEditorTagHelper(IHtmlHelper htmlHelper)
        {
