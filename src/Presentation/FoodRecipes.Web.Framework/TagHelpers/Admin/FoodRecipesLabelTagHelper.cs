...
namespace FoodRecipes.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("foodrecipes-label", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class FoodRecipesLabelTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesLabelTagHelper(IHtmlGenerator generator, ILocalizationService localizationService, IWorkContext workContext)
        {
            Generator = generator;
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                if (DisplayHint && For.Metadata.AdditionalValues.TryGetValue("NopResourceDisplayNameAttribute", out var value)
                    && value is FoodRecipesResourceDisplayNameAttribute resourceDisplayName)
                {
