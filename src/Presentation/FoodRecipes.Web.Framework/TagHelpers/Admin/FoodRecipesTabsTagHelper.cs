...
namespace FoodRecipes.Web.Framework.TagHelpers.Admin
{
    ...
    /// "nop-tabs" tag helper
    /// </summary>
    [HtmlTargetElement("foodrecipes-tabs", Attributes = ID_ATTRIBUTE_NAME)]
    public class FoodRecipesTabsTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            context.Items.Add(typeof(FoodRecipesTabsTagHelper), tabContext);
    ...
    public class NopTabTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<NopTabContextItem>)context.Items[typeof(FoodRecipesTabsTagHelper)];
