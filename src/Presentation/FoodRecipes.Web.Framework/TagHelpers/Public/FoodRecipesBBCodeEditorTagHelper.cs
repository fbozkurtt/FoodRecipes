...
namespace FoodRecipes.Web.Framework.TagHelpers.Public
{
    /// <summary>
    /// "nop-bb-code-editor" tag helper
    /// </summary>
    [HtmlTargetElement("foodrecipes-bb-code-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class FoodRecipesBBCodeEditorTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesBBCodeEditorTagHelper(IWebHelper webHelper)
        {
