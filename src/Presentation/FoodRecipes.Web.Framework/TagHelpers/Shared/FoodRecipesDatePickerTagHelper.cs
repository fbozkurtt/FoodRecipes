...
namespace FoodRecipes.Web.Framework.TagHelpers.Shared
{
    /// <summary>
    /// "nop-date-picker" tag helper
    /// </summary>
    [HtmlTargetElement("foodrecipes-date-picker", Attributes = DAY_NAME_ATTRIBUTE_NAME + "," + MONTH_NAME_ATTRIBUTE_NAME + "," + YEAR_NAME_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class FoodRecipesDatePickerTagHelper : TagHelper
    {
        #region Constants
        ...
        public FoodRecipesDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper, ILocalizationService localizationService)
        {
            Generator = generator;
